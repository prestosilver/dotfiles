...
(def-doom-theme doom-mondo
  ...
  ;; name        default   256       16
  ((bg         '("#2E3440" "#191919" nil))
   (bg-alt     '("#2E3440" "#222222"  nil))
   (base0      '("#434C5E" "#111122"   "black"))
   (base1      '("#3B4252" "#1C1C1C" "brightblack"))
   ...
   (base7      '("#f9f5d7" "#767676" "brightblack"))
   (base8      '("#D8DEE9" "#a8a8a8" "white"))
   (fg         '("#D8DEE9" "#d4d4d4" "brightwhite"))
   (fg-alt     '("#D8DEE9" "#bcbcbc" "white"))

   (grey base7)
   (white        '("#D8DEE9" "#FFFFFF" "white"))
   (red          '("#BF616A" "#FF5E5E" "red"))
   (orange       '("#81A1C1" "#FC9354" "brightred"))
   (green        '("#A3BE8C" "#468800" "green"))
   (light-green  '("#A3BE8C" "#BBCCAA" "green"))
   (teal         '("#88C0D0" "#33CCAA" "brightgreen"))
   (yellow       '("#EBCB8B" "#E9FDAC" "brightyellow"))
   (light-yellow '("#EBCB8B" "#FBE3BF" "brightyellow"))
   (blue         '("#5E81AC" "#8CDAFF" "brightblue"))
   (dark-blue    '("#5E81AC" "#6699CC" "blue"))
   (magenta      '("#D08770" "#CC88CC" "brightmagenta"))
   (violet       '("#B48EAD" "#BB88BB" "magenta"))
   (dark-violet  '("#B48EAD" "#662277" "magenta"))
   (cyan         '("#88C0D0" "#5FD7FF" "brightcyan"))
   (dark-cyan    '("#88C0D0" "#2277AA" "cyan"))

   ;; component focused
   (bottomline-blue '("#434C5E" "#2467D0" "blue"))
   (vcmodified-blue '("#434C5E" "#007B9F" "blue"))
   (vcdeleted-red '("#BF616A" "#9D0012" "red"))
